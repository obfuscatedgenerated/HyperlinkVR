...
export default defineContentScript({
    ...
    main() {
        ...
        // - defer (tells the host to display the fallback dom mirror as usual but listen for connections still) (the default) (TODO: implement, can we if we need to inject api at doc start?)
